...
async function assertRegisteredEmail(email: string) {
  const auth = getAuth();
  try {
...
/** Бүртгэлтэй имэйл эсэхийг шалгана — имэйлийг апп илгээнэ */
...
/** verifyEmailForPasswordReset-тэй ижил — хуучин клиентүүдэд */
export const requestPasswordReset = verifyEmailForPasswordReset;
