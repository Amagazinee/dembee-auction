...
class _FaqScreenState extends State<FaqScreen> {
  ...
  static const _items = [
    ...
    _FaqItem(
      question: 'Ялагч хэрхэн тодорхойлогддог вэ?',
      answer:
          '«Ялагч тодорхойлох» тооллого 0 болоход хамгийн сүүлд санал явуулсан хэрэглэгч ялагч болно. Санал бүр тооллогыг дахин эхлүүлнэ.',
    ),
    _FaqItem(
      question: '8 үе яаж ажилладаг вэ?',
      answer:
          'Дуудлага 8 үеэс бүрдэнэ. Үе бүр өөр хугацаатай. Үе дуусахад дараагийн үе рүү шилжинэ, ялагч тодорхойлох хугацаа богиносно.',
    ),
    _FaqItem(
    ...
    _FaqItem(
      ...
      answer:
          'Ялагч тодорхойлогдсны дараа бид тантай холбогдож хүргэлт эсвэл авах цэгийн мэдээллийг өгнө.',
    ),
    _FaqItem(
