  ...
  static String get platformSetupHint {
    if (kIsWeb) {
      return 'Та Chrome (Web) дээр ажиллуулж байна.\n'
          'flutterfire configure → Web платформыг сонгоно уу.';
    }
    return 'flutterfire configure → Android платформыг сонгоно уу.';
  }

  static String get firebaseNotReadyMessage {
    if (!isConfigured) {
      return 'Firebase тохируулаагүй. Терминалд flutterfire configure ажиллуулна уу.\n'
          '$platformSetupHint';
    }
    return 'Firebase холбогдоогүй. Аппыг бүрэн дахин ажиллуулна уу (q → flutter run).';
  }
}
