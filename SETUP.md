...
```powershell
firebase deploy --only firestore:rules,firestore:indexes --project dembee-auction
```
Апп, санал өгөх, админ самбар ажиллана — зөвхөн **автомат ялагч тодруулах** ажиллахгүй (UI тооллого л харуулна).
